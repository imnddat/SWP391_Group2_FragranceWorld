...
//        return map;
//    }
    public User updateProfileUser(String username, String pass, String email, String name, String address, String phone) {
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        User updatedUser = null;
        try {
            String sql = "update User set [username] = ?, [password] = ?, email = ?, [fullname] = ?, address = ?, phone = ? where [username] = ? ";
            conn = new DBConnection().getConnection();
            ps = conn.prepareStatement(sql);
            ...
            if (rowsAffected > 0) {
                ...
                if (rs.next()) {
                    ...
                    updatedUser.setUsername(rs.getString("pass"));
