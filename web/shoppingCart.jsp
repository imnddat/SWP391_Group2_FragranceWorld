                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="mt-bottom-bar">
                                    ...
                                    <nav id="nav">
                                        <ul>
                                            <li>
                                                <a  href="${pageContext.request.contextPath}/home">HOME <i class="fa fa-angle-down hidden-lg hidden-md" aria-hidden="true"></i></a>                     
                                            </li>
                                            <li>
                                ...
                                <div class="row border rowItem">
                                    <div class="col-xs-12 col-sm-2">
                                        <div class="img-holder">
                                            ...
                                            <%--<img src="${i.getPtoduct().getDefaultImg()}" alt="image description">--%>
                                        </div>
                                    </div>
