    ...
    <body>
        ...
        <div class="header">
            ...
            <div class="nav">
                ...
                <span> | </span>
                <a href="listcustomer">Customer Management</a>
                <span> | </span>
        ...
        <div class="content">
            ...
            <div class="content">
                ...
                <input value="${u.fullname}" readonly="">
                <br>
                
                <label>Date of birth: </label>
                <input value="<fmt:formatDate value="${u.dob}" pattern="dd/MM/yyyy" />" readonly="">
                <br>
                ...
                <label>Address:</label>
                <input value="${u.address}" readonly="">
