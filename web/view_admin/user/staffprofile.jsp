    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="content">
                ...
                <input value="${s.fullname}" readonly="">
                <br>
                
                <label>Position:</label>
                <input value="${s.getPosition().getPname()}" readonly="">
                <br>
                
                <label>Date of birth: </label>
                <input value="<fmt:formatDate value="${s.dob}" pattern="dd/MM/yyyy" />" readonly="">
                <br>
                ...
                <input value="${s.phone}" readonly=""> 
                <br>
                
                <label>Address:</label>
                <input value="${s.address}" readonly="">
